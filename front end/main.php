	...
	if(isset($_COOKIE['sess_user']))
	{
	   ...
	   if(isset($_POST['submit']))
	   {
	  	 if(!empty($_POST['phone_no']))
	  	 {
	  		 ...
	  		 echo $phone_no;
	  		 echo$_POST['phone_no'];
	  		 $query = mysqli_query($con,"SELECT farmer_id, mobile_no from farmer_details WHERE mobile_no='".$phone_no."'");
	  		 //echo $query;
	  		 ...
	  		 if ($numrows == 0)
	  		 {
	  			 ...
	  			 $sql = "INSERT INTO farmer_details (mobile_no) VALUES('$phone_no')";
